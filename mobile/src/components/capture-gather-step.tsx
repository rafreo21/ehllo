...
const styles = StyleSheet.create({
  ...
  transcriptBannerTitle: { color: colors.ink, fontSize: 14, fontFamily: fonts.bold, fontWeight: '800' },
  ...
  promptTitle: { color: colors.ink, fontSize: 17, fontFamily: fonts.bold, fontWeight: '800' },
  ...
  optionTitle: { color: colors.ink, fontSize: 16, fontFamily: fonts.bold, fontWeight: '800' },
  ...
  addedTitle: { color: colors.ink, fontSize: 15, fontFamily: fonts.bold, fontWeight: '800' },
  ...
  qrHint: { color: colors.ink, fontSize: 16, fontFamily: fonts.bold, fontWeight: '800', textAlign: 'center' },
