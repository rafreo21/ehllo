...
const styles = StyleSheet.create({
  ...
  personTriggerName: { color: colors.ink, fontSize: 16, fontFamily: fonts.bold, fontWeight: '800' },
  ...
  resultName: { color: colors.ink, fontSize: 15, fontFamily: fonts.bold, fontWeight: '800' },
  ...
  personChoiceTitle: { color: colors.ink, fontSize: 14, fontFamily: fonts.bold, fontWeight: '800' },
  centerCopy: { textAlign: 'center', marginTop: spacing.x3 },
  qrWrap: { alignItems: 'center', gap: spacing.x3, marginTop: spacing.x4 },
  qrHint: { color: colors.ink, fontSize: 14, fontFamily: fonts.medium, fontWeight: '700' },
