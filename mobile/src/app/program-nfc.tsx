...
const styles = StyleSheet.create({
  ...
  headerTitle: { color: colors.ink, fontSize: 25, lineHeight: 29, fontFamily: fonts.extrabold, fontWeight: '800', letterSpacing: -0.7 },
  ...
  title: { color: colors.ink, fontSize: 28, lineHeight: 31, fontFamily: fonts.extrabold, fontWeight: '800', letterSpacing: -0.9 },
  description: { color: colors.muted },
  errorText: { color: colors.danger, fontSize: 14, lineHeight: 20, fontFamily: fonts.bold, fontWeight: '700', marginTop: spacing.x2 },
  ...
  stepNumber: { color: colors.muted, fontSize: 13, fontFamily: fonts.extrabold, fontWeight: '800' },
  stepLabel: { flex: 1, color: colors.muted, fontSize: 15, fontFamily: fonts.bold, fontWeight: '700' },
  ...
  tipTitle: { color: colors.ink, fontSize: 15, fontFamily: fonts.extrabold, fontWeight: '800' },
});
