...
const styles = StyleSheet.create({
  ...
  summaryTitle: { color: colors.ink, fontSize: 16, fontFamily: fonts.extrabold, fontWeight: '800', textAlign: 'center' },
  ...
  count: { minWidth: 28, height: 28, borderRadius: 14, textAlign: 'center', lineHeight: 28, overflow: 'hidden', backgroundColor: colors.accent, color: colors.ink, fontFamily: fonts.extrabold, fontWeight: '800' },
  ...
  detailHeading: { color: colors.ink, fontSize: 17, fontFamily: fonts.extrabold, fontWeight: '800', marginBottom: spacing.x1 },
  ...
  itemTitle: { flex: 1, color: colors.ink, fontSize: 14, fontFamily: fonts.extrabold, fontWeight: '800' },
  ...
  waitingText: { color: colors.muted, fontSize: 11, fontFamily: fonts.bold, fontWeight: '700', marginTop: spacing.x1 },
  failureBox: { marginTop: spacing.x2, padding: spacing.x3, borderRadius: 12, backgroundColor: '#FFF1EE', gap: 3 },
  failureTitle: { color: colors.danger, fontSize: 11, fontFamily: fonts.extrabold, fontWeight: '800' },
