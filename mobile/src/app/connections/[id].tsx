...
const styles = StyleSheet.create({
  ...
  sectionTitle: { color: colors.ink, fontSize: 18, fontFamily: fonts.bold, fontWeight: '800' },
  viewAll: { color: colors.link, fontSize: 13, fontFamily: fonts.bold, fontWeight: '800' },
  list: { gap: spacing.x3 },
  meetingCell: {
    flexDirection: 'row',
    alignItems: 'center',
  ...
  meetingTitle: { color: colors.ink, fontSize: 15, fontFamily: fonts.bold, fontWeight: '800' },
  meetingMeta: { color: colors.muted, fontSize: 12, fontFamily: fonts.medium, fontWeight: '700' },
  meetingPlace: { color: colors.inkSoft, fontSize: 12, lineHeight: 17, fontFamily: fonts.medium, fontWeight: '700' },
  ...
  cardButtonTitle: { color: colors.white, fontSize: 15, fontFamily: fonts.bold, fontWeight: '800' },
