...
const styles = StyleSheet.create({
  ...
  greetingTitle: { color: colors.ink, fontSize: 30, lineHeight: 32, fontFamily: fonts.medium, fontWeight: '700', letterSpacing: -0.4 },
  ...
  bellBadgeText: { color: colors.ink, fontSize: 10, fontFamily: fonts.extrabold, fontWeight: '900' },
  scroll: { flex: 1 },
  scrollContent: {
    paddingHorizontal: spacing.x5,
  ...
  attentionHeadline: { color: colors.ink, fontSize: 16, fontFamily: fonts.bold, fontWeight: '800', letterSpacing: -0.2 },
  attentionSubline: { color: colors.muted, fontFamily: fonts.regular, fontSize: 13, lineHeight: 18 },
  attentionStat: { color: colors.ink, fontFamily: fonts.bold, fontWeight: '800' },
  ...
  activeWorkLabel: { flex: 1, color: colors.ink, fontSize: 13, fontFamily: fonts.medium, fontWeight: '700' },
  section: { gap: spacing.x3 },
  sectionHead: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' },
  sectionTitle: { color: colors.muted, fontSize: 13, fontFamily: fonts.medium, fontWeight: '700', letterSpacing: 0.1 },
  viewAll: { color: colors.link, fontSize: 12, fontFamily: fonts.bold, fontWeight: '800' },
  ...
  personTagText: { color: colors.ink, fontSize: 10, fontFamily: fonts.bold, fontWeight: '800' },
  myCardRow: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: spacing.x3,
  ...
  myCardLabel: { color: colors.ink, fontSize: 14, fontFamily: fonts.bold, fontWeight: '800' },
  myCardMeta: { color: colors.muted, fontFamily: fonts.regular, fontSize: 12 },
  myCardAction: { color: colors.link, fontSize: 12, fontFamily: fonts.bold, fontWeight: '800' },
