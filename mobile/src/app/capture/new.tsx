...
const styles = StyleSheet.create({
  ...
  loadingCopy: { color: colors.muted, fontFamily: fonts.regular, fontSize: 14 },
  page: { flex: 1 },
  ...
  backgroundStatusTitle: { color: colors.ink, fontSize: 14, fontFamily: fonts.extrabold, fontWeight: '800' },
  backgroundStatusBody: { color: colors.muted, fontFamily: fonts.regular, fontSize: 12, lineHeight: 18 },
  sourcePanel: {
    gap: spacing.x3,
    padding: spacing.x4,
    borderRadius: radius.medium,
  ...
  sourceHint: { color: colors.muted, fontFamily: fonts.regular, fontSize: 12, lineHeight: 18 },
  ...
  recordingStorageAction: { color: colors.ink, fontSize: 12, fontFamily: fonts.black, fontWeight: '900', textDecorationLine: 'underline' },
  input: {
    minHeight: 48,
  ...
  draftNote: { color: colors.muted, fontFamily: fonts.regular, fontSize: 12, lineHeight: 18 },
  ...
  extractCopy: { color: colors.muted, fontFamily: fonts.regular, fontSize: 12 },
  ...
  emptyCopy: { color: colors.muted, fontFamily: fonts.regular, fontSize: 13, lineHeight: 20 },
  ...
  optionalSectionTitle: { color: colors.ink, fontSize: 14, fontFamily: fonts.extrabold, fontWeight: '800' },
  optionalSectionHint: { color: colors.muted, fontFamily: fonts.regular, fontSize: 12, lineHeight: 17 },
  ...
  previewChipText: { color: colors.ink, fontSize: 11, fontFamily: fonts.bold, fontWeight: '700' },
  optionalSectionBody: {
    gap: spacing.x3,
    padding: spacing.x4,
    borderRadius: radius.medium,
  ...
  commitmentTitle: { color: colors.ink, fontSize: 14, fontFamily: fonts.extrabold, fontWeight: '800' },
  commitmentOption: {
    borderRadius: radius.medium,
    backgroundColor: colors.surface,
    borderWidth: 1,
  ...
  commitmentAssignmentLabel: { color: colors.muted, fontSize: 11, fontFamily: fonts.extrabold, fontWeight: '800', textTransform: 'uppercase' },
  ...
  assignmentChipText: { color: colors.ink, fontSize: 13, fontFamily: fonts.bold, fontWeight: '700' },
  assignmentChipTextSelected: { color: colors.white },
  commitmentCopy: { flex: 1, gap: 3 },
  commitmentOptionTitle: { color: colors.ink, fontSize: 13, lineHeight: 18, fontFamily: fonts.extrabold, fontWeight: '800' },
  commitmentMeta: { color: colors.muted, fontFamily: fonts.regular, fontSize: 11, lineHeight: 16, textTransform: 'capitalize' },
  commitmentUse: { color: colors.ink, fontSize: 12, fontFamily: fonts.black, fontWeight: '900' },
  ...
  channelText: { color: colors.ink, fontSize: 13, fontFamily: fonts.bold, fontWeight: '700' },
