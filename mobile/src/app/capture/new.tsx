...
const styles = StyleSheet.create({
  ...
  eventContext: { color: colors.ink, fontSize: 13, lineHeight: 18, fontFamily: fonts.medium, fontWeight: '700' },
  headerModeAction: {
    minHeight: 44,
    justifyContent: 'center',
  ...
  backgroundStatusTitle: { color: colors.ink, fontSize: 14, fontFamily: fonts.bold, fontWeight: '800' },
  ...
  actionTitle: { color: colors.ink, fontSize: 14, fontFamily: fonts.medium, fontWeight: '700' },
  ...
  optionalSectionTitle: { color: colors.ink, fontSize: 14, fontFamily: fonts.bold, fontWeight: '800' },
  ...
  previewChipText: { color: colors.ink, fontSize: 11, fontFamily: fonts.medium, fontWeight: '700' },
  optionalSectionBody: {
    gap: spacing.x3,
    padding: spacing.x4,
    borderRadius: radius.medium,
  ...
  commitmentTitle: { color: colors.ink, fontSize: 14, fontFamily: fonts.bold, fontWeight: '800' },
  commitmentOption: {
    borderRadius: radius.medium,
    backgroundColor: colors.surface,
    borderWidth: 1,
  ...
  commitmentAssignmentLabel: { color: colors.muted, fontSize: 11, fontFamily: fonts.bold, fontWeight: '800', textTransform: 'uppercase' },
  ...
  commitmentUse: { color: colors.ink, fontSize: 12, fontFamily: fonts.extrabold, fontWeight: '900' },
