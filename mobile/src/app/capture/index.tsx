...
const styles = StyleSheet.create({
  ...
  activeTitle: { color: colors.white, fontSize: 15, fontFamily: fonts.extrabold, fontWeight: '900' },
  activeDuration: { color: '#CFE1C8', fontSize: 13, fontFamily: fonts.bold, fontWeight: '800', marginTop: 2 },
  activeControl: {
    width: 46,
    height: 46,
    borderRadius: radius.medium,
  ...
  activeFinishText: { color: colors.white, fontSize: 13, fontFamily: fonts.extrabold, fontWeight: '900' },
  heroBlock: {
  ...
  quickContextTitle: { color: colors.ink, fontSize: 16, lineHeight: 20, fontFamily: fonts.extrabold, fontWeight: '900' },
  ...
  syncFooterText: { color: colors.muted, fontSize: 11, lineHeight: 15, fontFamily: fonts.medium, fontWeight: '700', textAlign: 'center' },
  historyTools: {
    zIndex: 2,
    paddingHorizontal: spacing.x5,
    paddingTop: spacing.x2,
  ...
  followUpText: { flex: 1, color: colors.ink, fontSize: 13, lineHeight: 18, fontFamily: fonts.medium, fontWeight: '700' },
  cardFooter: {
    flexDirection: 'row',
    alignItems: 'center',
  ...
  discardText: { color: colors.danger, fontSize: 12, fontFamily: fonts.bold, fontWeight: '800' },
  openRow: { flexDirection: 'row', alignItems: 'center', gap: 4 },
  openText: { color: colors.ink, fontSize: 12, fontFamily: fonts.bold, fontWeight: '800' },
});
