...
const styles = StyleSheet.create({
  ...
  eventChipText: { color: colors.ink, fontSize: 12, fontFamily: fonts.medium, fontWeight: '700', maxWidth: 220 },
  ...
  eventPickerRowText: { flex: 1, color: colors.ink, fontSize: 15, fontFamily: fonts.medium, fontWeight: '700' },
  recorderCard: {
    gap: spacing.x5,
    padding: spacing.x6,
  ...
  tabButtonText: { color: colors.muted, fontSize: 13, fontFamily: fonts.medium, fontWeight: '700' },
  tabButtonTextActive: { color: colors.ink, fontFamily: fonts.bold, fontWeight: '800' },
