...
export const metadata: Metadata = {
  title: "Privacy Policy · AfterMeet",
  description: "How AfterMeet collects, uses, and protects your data, including data accessed through Google and Microsoft integrations.",
};
  ...
  return (
    <main className="mx-auto w-full max-w-[760px] px-6 py-16 text-[#163300]">
      ...
      <div className="space-y-10 text-[15px] leading-relaxed text-[#163300]">
        <section>
          <p>
            AfterMeet (&ldquo;we&rdquo;, &ldquo;us&rdquo;) is a relationship workspace: you capture the people
        ...
        <section>
          ...
          <p className="mb-3">
            ...
            AfterMeet. If you choose to connect one from Settings, we request only the following, and only for
            the purposes below:
          </p>
          <ul className="list-disc space-y-2 pl-5">
            <li>
              <strong>Send email on your behalf</strong> (Gmail send / Outlook Mail.Send) &mdash; used only when
              you explicitly approve and send a follow-up email drafted in AfterMeet. We never read your inbox
            ...
            <li>
              ...
              &mdash; used to suggest events you may want to add to AfterMeet (for example, an upcoming meeting
            ...
            <li>
              ...
              scoped only to files AfterMeet itself creates; we cannot see or access any other file in your
              Drive or OneDrive.
            </li>
          </ul>
          <p className="mt-3">
        ...
        <section>
          ...
          <p>
            We share data only with the service providers needed to run AfterMeet (hosting, database, AI
            processing, transactional email) under agreements that restrict them to providing that service, and
            with other AfterMeet users only to the extent you choose to share it &mdash; for example, publishing
