...
import { HorizontalLoops } from "./HorizontalLoops";
...
export default function HomepageDraft() {
  return <main className="homepage-draft">
    <DraftMotion/>
    <div className="draft-review-bar"><strong>Homepage Draft Variation</strong><span>Exploration only · current homepage unchanged</span><a href="/">View current</a></div>
    <nav className="nav">
      <a className="brand" href="#top" aria-label="AfterMeet draft home"><BrandMark className="brand-mark" size={38}/><span>AfterMeet</span></a>
    ...
    <section className="hero draft-hero" id="top">
      ...
      <div className="hero-bottom"><p>Meet someone, remember what mattered, and know what to do next. <small>AfterMeet keeps the people, context and next actions connected.</small></p><IconLinkButton className="circle-link" size="normal" variant="secondary" href="#lifecycle" aria-label="See how it works"><ArrowDownIcon size={21} weight="bold"/></IconLinkButton></div>
    </section>
    ...
    <section className="study section draft-reveal" id="lifecycle">
      ...
      <div className="draft-story-grid">
        <div><h2>One conversation.<br/><em>A relationship remembered.</em></h2><p className="lede">AfterMeet turns the moment you meet into context you can use—without turning the conversation into CRM admin.</p></div>
        <LifecycleDemo/>
      </div>
    ...
    <footer><div><BrandMark className="brand-mark" size={38}/><strong>AfterMeet</strong></div><p>Meet someone. Remember what mattered. Make the next move.</p><LinkButton variant="ghost" href="/auth?next=/onboarding">Start for free <ArrowUpIcon size={15} weight="bold"/></LinkButton></footer>
  </main>;
}
