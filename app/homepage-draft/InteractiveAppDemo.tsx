    ...
    <div className="draft-app-sticky section">
      ...
      <div className="draft-phone-wrap">
        <div className="draft-phone" aria-live="polite">
          <div className="draft-phone-status"><span>9:41</span><b>AfterMeet</b><span>•••</span></div>
          <div className={`draft-phone-screen direction-${direction}`} key={`${active}-${completed}`}>
            ...
            {active===0 && <div className="draft-qr"><div className="draft-qr-grid">{Array.from({length:49},(_,i)=><i className={(i*7+i*3)%5<2?"on":""} key={i}/>)}</div><strong>Rafael · AfterMeet</strong><small>Scan to connect</small></div>}
