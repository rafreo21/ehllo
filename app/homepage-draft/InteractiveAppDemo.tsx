  ...
  return <section className="draft-app-demo draft-reveal" id="app-demo" ref={sectionRef}>
    <div className="draft-app-sticky section">
      ...
      <div className="draft-app-copy">
        ...
        <p className="draft-build-note"><strong>Current product preview.</strong> Some screens, integrations and finishing details shown in the wider story are still being added and may change before release.</p>
